...
//The asteroids when destroyed break off into 2 medium sized asteroids then into 2 small sized asteroids 
// when the asteroids spawn should come in from the side and not just spawn in the middle of the map
